...
The ``CHANGELOG`` will be read by users, so this description should be aimed at MUSE users instead of describing internal changes which are only relevant to the developers.
