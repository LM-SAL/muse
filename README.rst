...
We love contributions! muse is open source,
built on open source, and we'd love to have you hang out in our community.

If you would like to get involved, check out the `Developers Guide`_ section of the SunPy docs.
The instructions are for SunPy but you just need to replace sunpy with muse.
Help is always welcome so let us know what you like to work on, or check out the `issues page`_ for the list of known outstanding items.


.. _Developers Guide: https://docs.sunpy.org/en/latest/dev_guide/index.html
.. _issues page: https://github.com/LM-SAL/muse/issues/
